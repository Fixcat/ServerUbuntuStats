...
2. Название: `ServerUbuntuStats`
3. Описание: `Comprehensive system monitoring tool for Ubuntu and Ubuntu Server`
4. Выберите **Public**
...
```bash
# Для репозитория Fixcat/ServerUbuntuStats
git remote add origin https://github.com/Fixcat/ServerUbuntuStats.git
git branch -M main
